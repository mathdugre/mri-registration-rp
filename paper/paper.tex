...
then it will reach a critical \HL{region} \TG{``the model''
	doesn't reach a czone. Do you mean that the optimal value theta star will?} bounding the loss gradient
norm as follows:
\begin{equation}
...
reproducibility across CPU microarchitectures. \HL{The code used for these
	experiments is available online at:} \url{https://github.com/mathdugre/mri-registration-rp}
...
propagated from preceding steps. \HL{Consequently, low-precision formats such as
	...
	intermediate aligned volumes.} \TG{This is an important result and should be mentioned in the abstract}
