...
sufficient that} the precision $p$ satisfies\TG{I think the logic is
	...
	converge, which you should note.}\MD{Modified the text to clarify the meeting
	the bound is sufficient but not necessary for convergence.}:
\begin{equation}
