...
\begin{abstract}
	...
	sufficient in ANTs registration. \HL{However, while our model can predict
	precision requirements, it} tends to underestimate the number of precision bits
	required by 11.6\%, on average \TG{I don't understand this statement, it looks contradictory}.
